...
int main(void)
{
  ...
  while (1)
  {
	  ...
	  if(COMM_flaga == 1){
		  ...
		  if (I5_MA == 0){ibus_data[5] = 1000;} 				//JEÅšLI NIE MA TRYBU W ODPOWIEDNIM RANGE TO STOP
		  ...
		  //JEÅšLI WYÅ?Ä„CZONY TO TRYB MANUALNY NADPISUJACY ZEROWE STEROWANIA
		  if (OFF_ON == 0){ MA = 0;}
