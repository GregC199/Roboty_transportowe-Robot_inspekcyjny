...
#define DIR_LT_Pin GPIO_PIN_3
#define DIR_LT_GPIO_Port GPIOA
#define DIR_PT_Pin GPIO_PIN_4
#define DIR_PT_GPIO_Port GPIOA
#define ENCODER_A_RT_Pin GPIO_PIN_6
#define ENCODER_A_RT_GPIO_Port GPIOA
#define ENCODER_B_RT_Pin GPIO_PIN_7
#define ENCODER_B_RT_GPIO_Port GPIOA
...
#define SERWO_KAT_Pin GPIO_PIN_12
#define SERWO_KAT_GPIO_Port GPIOA
#define KRANCOWKA_2_Pin GPIO_PIN_3
#define KRANCOWKA_2_GPIO_Port GPIOB
#define KRANCOWKA_1_Pin GPIO_PIN_4
